...
sap.ui.define(
  ["sap/ui/demo/bulletinboard/model/DateFormatter", "sap/ui/core/Locale"],
  function (DateFormatter, Locale) {
    ...
    QUnit.test(
      "Should return empty string if no date is given",
      function (assert) {
    ...
    QUnit.test(
      "Should return 'Yesterday' if date from yesterday",
      function (assert) {
    ...
    QUnit.test(
      "Should return day of the week if date < 7 days ago",
      function (assert) {
    ...
    QUnit.test(
      "Should return date w/o time if date > 7 days ago",
      function (assert) {
